...
// The workbench's half of the landing page: the Projects the caller belongs to. A Project is the
// access boundary an Analysis is bound to, so it is the level a curator navigates first. Counts and
// the latest Analysis date come from one read over the whole membership, not one per Project.
//
// Self-contained: it resolves its own caller and does its own reads, so the landing page composes
// it without holding a backend or knowing what a Project is.
    ...
    <section className="flex flex-col gap-[24px]">
      <div className="flex flex-col gap-[6px]">
        ...
        <p className="text-[13px] text-ink-muted">
          A Project holds the datasets and people an Analysis is scoped to. Open
          one to see its analyses, or start a new one.
        </p>
      </div>
