 ...
 * markdown body with citation directives. A turn with no text (an agent turn that only makes tool
 ...
 * it targets (agent-output-rendering.md, "The BFF diffs a replacement").
 *
 ...
 * empty text. `result` is absent until the call returns. (agent-output-rendering.md, "The projection
 * decides how a tool call looks".)
 *
 ...
 * (agent-output-rendering.md, "A body's language is read from its text").
 *
